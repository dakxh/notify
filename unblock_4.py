...
STATE_FILE = "barco_second_2_days_state.json"
...
def fetch_sessions():
    ...
    for date_code in DATES:
        ...
        try:
            ...
            print(f"    -> Found {len(shows)} total shows for this date. Filtering for PCX HDR BY BARCO SCREEN...")
            ...
            for show in shows:
                if show.get("attributes") == "PCX HDR by BARCO":
                    ...
                    pcx_count += 1
            print(f"    -> Filtered {pcx_count} PCX HDR by BARCO SCREEN sessions for {date_code}.")
...
def main():
    ...
    print(f"\n✅ Found a total of {total_sessions} PCX HDR by BARCO SCREEN sessions to monitor.")
    print("==================================================")
